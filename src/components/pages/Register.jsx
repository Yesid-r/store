...
const Register = () => {
    ...
    return (
        <div className="bg-white border rounded-sm  flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-8">
                            <form onSubmit={handleSubmit}>
                                ...
                                <div>
                                    <label htmlFor="lastName" className="block mb-2 text-sm text-gray-600 ">Apellidos</label>
                                    <input
                                        type="text"
                                        name="lastName"
                                        id="lastName"
                            ...
                            <p className="mt-6 text-sm text-center text-gray-400">¿Ya tienes una cuenta? <a href="/login" className="text-blue-500 focus:outline-none focus:underline hover:underline">Iniciar sesión</a>.</p>
                            <div className="mt-4 flex items-center justify-between">
                                <span className="border-b w-1/5 lg:w-1/4"></span>
                                <a href="#" className="text-xs text-center text-gray-500 first-letter:uppercase">o </a>
                                <span className="border-b w-1/5 lg:w-1/4"></span>
                            </div>
                            <a href="#" className="flex items-center justify-center mt-4 bg-gray-50 text-white rounded-lg shadow-md hover:bg-gray-200">
                                ...
                                <h1 className="px-4 py-3 w-5/6 text-center text-gray-600 font-bold">Registrarse con Google</h1>
                            </a>
                        </div>
                    </div>
                </div>
